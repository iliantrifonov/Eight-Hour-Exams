...
namespace Web.Tests.Integration
{
    public class InMemoryHttpServer
    {
        ...
        public InMemoryHttpServer(string baseUrl, IBullsAndCowsData data)
        {
        ...
        public HttpResponseMessage CreateDeleteRequest(string requestUrl, object data, string mediaType = "application/json")
        {
            var url = requestUrl;
            var request = new HttpRequestMessage();
            request.RequestUri = new Uri(baseUrl + url);
